...
>
> 几个亮点：
> - 不是贴标签，是用数据做精准洞察——"面食专精型，小红书收藏34条面食做法"这种级别
...
- ❌ "喜欢美食" → ✅ "面食专精型，小红书收藏34条面食做法，B站追老饭骨(15条)"
- ❌ "关注游戏" → ✅ "像素风独立游戏开发者，B站93条教程收藏分4个夹子"
- ❌ "读过很多书" → ✅ "213本书打分率69%，硬科幻信徒，唯一一星给了某鸡汤书"
...
**事实**（直接从数据得出）：
- "B站关注了RNG/BLG/JDG/EDG" → 可以直接说
- "豆瓣标记177部电影" → 可以直接说

**推断**（需要标注为猜测，用柔和措辞）：
- ❌ "正在考研" → ✅ "从小红书系统性收藏了10条软微金科备考资料来看，**可能在准备或计划考研**"
- ❌ "有运动伤" → ✅ "收藏了核磁/韧带相关内容，**似乎关注运动损伤恢复**"
- ❌ "有男朋友" → ✅ "收藏了纪念日/约会/送男朋友礼物相关内容"（**只陈述事实，不做感情推断**）
...
```json
{
  ...
  "platforms": {
    "douyin": {"status": "success", "collected_at": "...", "counts": {"works": 13, "following": 214}},
    "xiaohongshu": {"status": "success", "counts": {"favorites": 209, "liked": 58}},
